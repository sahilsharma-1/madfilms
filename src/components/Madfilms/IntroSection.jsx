...
<motion.div
  ...
  viewport={{ once: true }}
  transition={{ duration: 0.7 }}
  className="relative h-64 w-full overflow-hidden rounded-2xl bg-black shadow-2xl sm:h-80 md:h-96 lg:h-[340px] lg:rounded-[28px]"
>
  <iframe
    className="absolute inset-0 h-full w-full"
    src="https://player.vimeo.com/video/1210863131?autoplay=1&muted=1&loop=1&background=1&autopause=0&title=0&byline=0&portrait=0"
    title="Nestlé Talent Attraction Dashboard Video Teaser"
    frameBorder="0"
